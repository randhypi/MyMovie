...
object DummyMovies {
    ...
    fun moviesDummy(): List<com.capstone.core.data.source.local.entity.MoviesEntity> {
        val movies = ArrayList<com.capstone.core.data.source.local.entity.MoviesEntity>()

        movies.add(
            com.capstone.core.data.source.local.entity.MoviesEntity(
                moviesId = "19404",
                originalLanguage = "hi",
                ...
                overview = "Raj is a rich, carefree," +
                        ...
                        " Baldev Singh, who in spite of being an " +
                        "NRI is very strict about adherence to Indian " +
                        "values. Simran has left for India to be married " +
                        "to her childhood fiancé. Raj leaves for India with " +
                        "a mission at his hands, to claim his lady love under " +
        ...
        movies.add(
            com.capstone.core.data.source.local.entity.MoviesEntity(
                ...
                overview = "Framed in the 1940s for the double" +
                        ...
                        "Shawshank prison, where he puts his accounting skills " +
                        "to work for an amoral warden. During his long stretch " +
                        "in prison, Dufresne comes to be admired by the other inmates -- " +
                        "including an older prisoner named Red -- for his integrity " +
        ...
        movies.add(
            com.capstone.core.data.source.local.entity.MoviesEntity(
                ...
                overview = "Professor Gabriel Emerson finally learns the truth" +
                        ...
                        "well-respected Dante specialist to remember her and wants " +
                        "nothing more to do with him. Can Gabriel win back her heart " +
        ...
        movies.add(
            com.capstone.core.data.source.local.entity.MoviesEntity(
                ...
                overview = "In a time of superstition and magic, when wolves are seen as demonic and " +
                        ...
                        " their friendship leads her to discover the world of the Wolfwalkers and transform" +
